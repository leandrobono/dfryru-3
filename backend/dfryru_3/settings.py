"""
Django settings for dfryru_3 project.
...
WSGI_APPLICATION = 'dfryru_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dfryru_3 API",
    "DESCRIPTION": "API documentation for dfryru_3 App",
    "VERSION": "v1",
}
